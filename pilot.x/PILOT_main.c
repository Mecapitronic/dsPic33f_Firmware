...
_PILOT_
{
    ...
    if (!START_PILOT && RECALAGE_PILOT) // Sequence de Recalage sur bordure
    {
        ...
        // le robot est face contre le panier, avec une calle sur le cot� entre la bordure et lui
        // valeur entre le milieu du robot et le panier : 114mm, entre le milieu du robot et la bordure : 225mm
        // Au recalage : init position, recule, monte la pince, d�sactive les servos et avance au maximum vers le panier
    ...
    if (mode == MODE_MATCH)
    {
        ...
        // Retour au panier et dépose cerises
